...
class PerPostRedditArchiver:
    ...
    async def download_post_assets(self, client: httpx.AsyncClient, post_item: dict, index: int):
        ...
        # 1. Save Meta & Title Asset (Including Post Datetime)
        ...
        with open(title_path, "w", encoding="utf-8") as f:
            ...
            f.write(f"Published Date/Time: {post_item['created_at']}\n")
            f.write(f"URL: {post_item['url']}\n")

        # 2. Save Comments Asset (with Comment Datetime)
        ...
        # 3. Save Screenshot Asset (Move temporary worker screenshot to final home)
    ...
    async def scrape_comments_worker(self, context, post_item: dict, index: int):
        ...
        try:
            ...
            while True:
                ...
                await page.wait_for_timeout(2000)  # Wait for comments to stream in
            ...
            # Using full_page=True to get everything, or omit it to screenshot just the viewport
            ...
            for comment in comment_elements:
                ...
                comment_time = await comment.get_attribute("created-timestamp") or "Unknown"
    ...
    async def run(self):
        async with async_playwright() as p:
            ...
            for post in post_elements:
                ...
                post_time = await post.get_attribute("created-timestamp") or "Unknown"
